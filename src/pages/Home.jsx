  ...
  return (
    <>
      ...
      <section className="banner">
        <img src="imagens/banners/banner.gif" className="banner-img" />
        <div className="banner-content container">
          <img src="imagens/banners/apoio.png" className="banner-logo" />
